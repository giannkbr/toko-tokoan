...
<h1><?php echo $title ?></h1>
					...
					<tbody>
						...
						<tr>
							<td>
								...
								<select id="ongkir" class="form-control" onchange="ongkir()">
	...
	var tes = document.getElementById("ongkir").value;
        document.getElementById("totalongkir").value=tes;
	}
	</script>