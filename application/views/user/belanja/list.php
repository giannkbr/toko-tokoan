...
<h1><?php echo $title ?></h1>
	...
	<div class="container">
		...
		$produk 	= $this->Modelproduk->detail($id_produk);
		// Total Belanjaan
		$total_belanja	=	'Rp '.number_format($this->cart->total(),'0',',','.');
		?>

							<tr class="table_row">
								<td><a href="<?php echo base_url('belanja/hapus/'.$keranjang['rowid']) ?>"
										class="flex-c-m size-50 bg8 bor13 hov-btn3 p-all-10 trans-04 m-lr-20 cl8"><i
											class="fa fa-trash"></i></a></td>
								<td class="">
									<a href="<?php echo base_url('produk/detail/'.$produk->slug_produk) ?>">
										<div class="m-r-20">
											<img height="60"
												src="<?php echo base_url('assets/upload/image/thumbs/'.$produk->gambar) ?>"
								...
								<td class="column-3">Rp <?php echo number_format($keranjang['price'],'0',',','.') ?>
								</td>
								<td class="column-4">
									<div class="wrap-num-product flex-w m-l-auto m-r-0">
										...
										<input class="mtext-104 cl3 txt-center num-product" type="number" name="qty"
											value="<?php echo $keranjang['qty'] ?>" max="<?php echo $produk->stok?>">
								...
								<td class="column-6">
									<button type="submit" name="update"
										class="flex-c-m size-50 bg8 bor13 hov-btn3 p-all-10 trans-04 m-r-30">
