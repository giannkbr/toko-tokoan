	...
	<table class="table stext-107">
		...
		<tbody>
			...
			<tr>
				<td><?php echo $i ?></td>
				<td>
					<a href="<?php echo base_url('dasbor/detail/'.$detail_transaksi->kode_transaksi) ?>">
				...
				<!-- <td>
					<a href="<?php echo base_url('dasbor/konfirmasi/'.$detail_transaksi->kode_transaksi) ?>" class="cl8 size-50 bg8 bor13 hov-btn3 p-all-10 trans-04"><i class="fa fa-upload"></i> Konfirmasi</a>
				</td> -->
			</tr>
			<?php $i++; } ?>
		</tbody>
