						...
						<tbody>
							<tr>
								...
								<th><input type="text" name="nama_pelanggan" class="form-control"
										...
										required title="Hanya Boleh Huruf dan Spasi" pattern="[A-Za-z\s]+"></th>
							</tr>
							<tr>
								<td>Email</td>
							...
							<tr>
								...
								<td><input type="text" name="telepon" class="form-control" placeholder="Telepon"
										value="<?php echo $pelanggan->telepon ?>" required title="Nomor Tidak Valid"
										pattern="[0-9]{11,14}">
									<small class="text-danger">Harus diawali dengan 62 dan tanpa menggunakan
										spasi</small>
								</td>
							</tr>
							<tr>
