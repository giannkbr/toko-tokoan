						...
						<tbody>
							...
							<tr>
								...
								<td>: <?php if ($detail_transaksi->bukti_bayar != "") { ?>
									<img src="<?php echo base_url('assets/upload/image/'.$detail_transaksi->bukti_bayar) ?>"
					...
					<table class="table">
						<tbody>
								...
								<td>
									<select name="id_rekening" class="form-control">
										...
										<option value="<?php echo $rekening->id_rekening ?>"
											<?php if ($detail_transaksi->id_rekening==$rekening->id_rekening) {echo "selected"; } ?>>
							...
							<tr>
								...
								<td>
									<input type="text" name="tanggal_bayar" class="form-control"
										...
										value="<?php if(isset($_POST['tanggal_bayar'])) { echo set_value('tanggal_bayar'); } elseif ($detail_transaksi->tanggal_bayar!="") { echo $detail_transaksi->tanggal_bayar; } else { echo date('d-m-Y'); } ?>">
								</td>
							</tr>
							<tr>
								...
								<td>
									<input type="number" name="jumlah_bayar" class="form-control"
										...
										value="<?php if(isset($_POST['jumlah_bayar'])) { echo set_value('jumlah_bayar'); } elseif($total_harga!=""){ echo $total_harga; } else{ echo $total_harga; } ?>">
								</td>
							</tr>
							<tr>
								<td>Dari Bank</td>
								<td>
									<input type="text" name="nama_bank" placeholder="Nama Bank" class="form-control"
										value="<?php echo $detail_transaksi->nama_bank ?>">
							...
							<tr>
								...
								<td>
									<input type="text" name="rekening_pembayaran" placeholder="Nomor Rekening"
										class="form-control"
										value="<?php echo $detail_transaksi->rekening_pembayaran ?>">
							...
							<tr>
								...
								<td>
									<input type="text" name="rekening_pelanggan" placeholder="Nama Pemilik Rekening"
										class="form-control"
										value="<?php echo $detail_transaksi->rekening_pelanggan ?>">
							...
							<tr>
								...
								<td>
									<input type="file" name="bukti_bayar" placeholder="Upload Bukti Pembayaran"
										class="form-control">
								</td>
							</tr>
							...
							<tr>
								...
								<td>
									<button type="submit" name="submit"
										class="cl8 size-50 bg8 bor13 hov-btn3 p-all-10 trans-04"><i
											class="fa fa-upload"></i> Submit</button>
									<button type="reset" name="reset" class="btn btn-default"><i
