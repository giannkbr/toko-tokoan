...
<div class="container">
	<div class="bread-crumb flex-w p-l-25 p-r-15 p-t-30 p-lr-0-lg">
		...
		<span class="stext-109 cl4">
			Invoice #<?php echo $detail_transaksi->kode_transaksi ?>
		</span>
	</div>
	...
	<div class="container">
		<div class="p-b-10 m-l-21">
			...
			<h3 class="ltext-103 cl5">
				<?php echo $title ?> #<?php echo $detail_transaksi->kode_transaksi ?> <span
					style="background-color: #5cb85c; font-size: 10pt;"
					class="stext-101 cl0 size-101 bor1 p-lr-15">PAID</span>
			</h3>
			<?php } elseif ($detail_transaksi->status_bayar == 'Menunggu Konfirmasi') { ?>
			<h3 class="ltext-103 cl5">
				<?php echo $title ?> #<?php echo $detail_transaksi->kode_transaksi ?> <span
					style="background-color: #f0ad4e; font-size: 10pt;"
					class="stext-101 cl0 size-101 bor1 p-lr-15">PROCESS</span>
			</h3>
			<?php } elseif ($detail_transaksi->status_bayar == 'Belum') { ?>
			<h3 class="ltext-103 cl5">
				<?php echo $title ?> #<?php echo $detail_transaksi->kode_transaksi ?> <span
					style="background-color: #d9534f; font-size: 10pt;"
					class="stext-101 cl0 size-101 bor1 p-lr-15">UNPAID</span>
			</h3>
			<?php } ?>
		</div>
		<div class="row">
				...
				if ($detail_transaksi) { ?>
					...
					<table class="table table-bordered stext-107">
						...
						<tbody>
							...
							<tr>
								<td>Ongkir</td>
								<td>: Rp <?php echo number_format($detail_transaksi->ongkir,0,',','.') ?>,-
							</tr>
						</tbody>
					</table>
...
// Kalau ga ada tampilkan notif
			...
			<div class="col-sm-10 col-lg-7 col-xl-4 m-lr-auto m-b-50">
				...
				<?php if ($detail_transaksi->status_bayar == "Belum"): ?>

				<!-- MENU KONFIRMASI -->
				<div style="background-color: #717fe0"
					class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm m-b-20">
					...
					<div class="flex-w flex-t p-t-27">
						...
						<select id="dropDown" class="form-control">
							...
							<option value="div<?php echo $rekening2->id_rekening ?>"><?php echo $rekening2->nama_bank ?>
							</option>
						...
						<div id="div<?php echo $rekening2->id_rekening ?>" class="drop-down-show-hide">
							<p class="stext-102 cl0">
								...
								<span class="stext-110 cl0"><?php echo $rekening2->nama_bank ?> A.n.
									<?php echo $rekening2->nama_pemilik ?> No. Rek.
									<?php echo $rekening2->nomor_rekening ?></span> <br><br>
								*Pastikan Anda sudah mentransfer uang sebelum mengeksekusi tombol. <br><br>
								Mohon tuliskan berita: <br>
								<span
									class="stext-110 cl0">INVOICE-<?php echo $detail_transaksi->kode_transaksi ?></span><br>
								Pada kolom berita transfer.
							</p><br>
							<a href="<?php echo base_url('dasbor/konfirmasi/'.$detail_transaksi->kode_transaksi) ?>"
								class="flex-c-m stext-101 cl0 size-116 bg5 bor14 hov-btn2 p-lr-15 trans-04 pointer">
								Konfirmasi
							</a>
						</div>
						<?php endforeach ?>
				...
				<div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
					...
					<a href="<?php echo base_url('Dasbor/cetak/'.$detail_transaksi->kode_transaksi) ?>" target="_blank"
						class=""><i class="fa fa-file-pdf-o"></i> Cetak Invoice</a>
				</div>
				<!-- END MENU CETAK -->
